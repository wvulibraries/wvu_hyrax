...
RSpec.feature 'Create a BasicWork', js: false do
  context 'a logged in user' do
    ...
    scenario do
      ...
      # choose "payload_concern", option: "BasicWork"
      # click_button "Create work"

      expect(page).to have_content "Add New Basic work"
      ...
      # its element
      find('body').click
      choose('basic_work_visibility_open')
